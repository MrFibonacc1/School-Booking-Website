...
//These are all just methods used to make page look nice and create abbreviations

//Change the format of date and time to suite SQL database
//It will detect date by slashes and then reorder the dates to suite the database style

//Option to make calender bigger
//When button is clicked, it will initiate the function to shrink/grow the calender

//Method to get current time
//When it gets the current time of the computer, it will make that day active

//Create the calender system by getting number of days in year and change according to leap years
//Then makes the calender the length of this number per year

//Methods to add string together for the date
//Ths is done using concatenation of two and 3 strings
