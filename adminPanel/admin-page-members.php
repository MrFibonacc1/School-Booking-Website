...
//This page showcases all the current members of the school system, e.g. accepted by the admin into the system
...
//In each loop, it gets data for every accepted member, if there are any
//The user has the option to block them or remove them, which will redirect them to another page
//There are multiple PHP forms used to create the block and remove buttons, two PHP forms are 
...
<a href="admin-page-members.php" class="request_1_active">Current Members<hr></a>
...
<div class="request_separation_2">
    ...
    <!-- <a href="deny_request.php" class="request_buttons" id="req_btn_2">Remove</a> -->
    <form action="deny_request.php" method="POST">
        ...
        <input type="submit" name="submitbtn" class="request_buttons_new" id="req_btn_2" value="Remove">
